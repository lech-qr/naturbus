 ...
 *
 * Template Name: Opole - Warszawa
 */

?>

<?php
$rozklad_1 = cptr_populate(8413);
$rozklad_2 = cptr_populate(8382);
?>
                        ...
                        <div class="row schedule-content">
                            <div class="col-md-12">
                                ...
                                foreach ($rozklad_1 as $przystanek) {
                                    $godziny_odjazdu_qr = get_post_meta($przystanek->ID, 'wpcf-warszawa-opole',false);
...
//                                    print_r($godziny_odjazdu_unique);
                    ...
                    <section class="second-schedule single-schedule">
                        <div class="schedule-name">
                            Opole Lubelskie - Poniatowa - Bełżyce - Nałęczów - Warszawa
                        </div>
                        <div class="row schedule-content">
                            <div class="col-md-12">
                                <?php
                                ...
                                foreach ($rozklad_2 as $przystanek) {
                                    $godziny_odjazdu_qr = get_post_meta($przystanek->ID, 'wpcf-opole-warszawa',false);
                                    $godziny_odjazdu = array_merge($godziny_odjazdu_qr);
                                    $godziny_odjazdu_unique = array_unique($godziny_odjazdu);
