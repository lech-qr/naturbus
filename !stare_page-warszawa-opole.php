...
<?php
    $rozklad_1 = cptr_populate(8382);
    $rozklad_2 = cptr_populate(get_the_ID());
$n = 0;
?>
...
<?php get_header();?>
    <section class="page-content" id="pageContent">
        <div class="container">
            <div class="row">
<!--                <div class="col-lg-4 show-desktop">-->
<!--                    <div class="schedule-sidebar">-->
<!--                        <div class="sidebar-title widget-title">-->
<!--                            Warszawa - Dęblin - Puławy - Nałęczów - Opole Lubelskie-->
<!--                        </div>-->
<!--                        <ul class="sidebar-schedule-list">-->
<!--                            --><?php //foreach ($rozklad_1 as $item) {
//                                $nazwa_przystanka = get_the_title($item);
//                                $n++;
//                                ?>
<!--                                <li class="single-schedule-sidebar">-->
<!--                                --><?php //echo $n; ?><!--. --><?php //echo $nazwa_przystanka; ?>
<!--                                </li>-->
<!--                            --><?php //} ?>
<!--                        </ul>-->
<!--                    </div>-->
                ...
                <div class="col-md-12 col-lg-12">
                    <section class="first-schedule single-schedule">
                        <div class="schedule-name">
                            Warszawa - Nałęczów - Bełżyce - Poniatowa - Opole Lubelskie
                        </div>
                                                                ...
                                                                <?php } elseif (in_array($godzina, $godziny_odjazdu_sobota)) { ?>
                                                                    <div class="col-md-2">
                                                                        <div class="single-hour standard-hour">
                                                                            <div class="hour">
                                                                                <span><?php echo $godzina; ?></span><span class="lower">D, 6</span>
                                                                            </div>
                                                                            <div class="desc">
