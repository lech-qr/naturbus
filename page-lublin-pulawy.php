 ...
 *
 * Template Name: Lublin - Puławy
 */

?>

<?php
$rozklad_1 = cptr_populate(8470);
$rozklad_2 = cptr_populate(8468);
                        ...
                        <div class="row schedule-content">
                            <div class="col-md-12">
                                ...
                                foreach ($rozklad_1 as $przystanek) {
                                    $godziny_odjazdu_qr = get_post_meta($przystanek->ID, 'wpcf-lublin-pulawy',false);
                        ...
                        <div class="row schedule-content">
                            <div class="col-md-12">
                                ...
                                foreach ($rozklad_2 as $przystanek) {
                                    $godziny_odjazdu_qr = get_post_meta($przystanek->ID, 'wpcf-pulawy-lublin',false);
                                    $godziny_odjazdu = array_merge($godziny_odjazdu_qr);
                                    $godziny_odjazdu_unique = array_unique($godziny_odjazdu);
