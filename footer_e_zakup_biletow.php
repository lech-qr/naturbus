...
<?php
    ...
    $bottomBlock = html_entity_decode(autozone_get_option('footer_settings_copyright', esc_html__('Copyright 2017. Design by Templines', 'autozone') ));
...
<!--<script type="text/x-epodroznik-module" data-module-name="PurchaseProcess" id="PurchaseProcess"></script>-->
</body></html>